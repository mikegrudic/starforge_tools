...
You can also browse the dataset directly `here <https://users.flatironinstitute.org/~mgrudic/starforge_data>`__.
...
It is also possible to perform limited analysis and computation with the data on Rusty directly via `Binder <https://wiki.flatironinstitute.org/Public/UsingFiBinder>`_:
 ...
 1. Provide a gmail address you will use (if your institution uses gmail, your institution email will work) by `opening an issue on the GitHub repo <https://github.com/mikegrudic/starforge_tools/issues>`_ or contacting a STARFORGE collaboration member - it must be added to the permissions list.
