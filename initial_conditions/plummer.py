...
cdf = lambda Rp, rr: (2*(Rp*np.sqrt(1 - Rp**2)*(-105 + 1210*Rp**2 - 2104*Rp**4 + 1488*Rp**6 - 384*Rp**8) + 105*np.arcsin(Rp)))/(105.*np.pi) - rr
...
boxsize = 10.
F = h5py.File("plummer_%d_m%g_a%g.hdf5"%(int(N**(1./3)+0.5),m, a),'w')
