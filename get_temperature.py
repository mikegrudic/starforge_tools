...
def get_temperature(internal_egy_code, helium_mass_fraction, electron_abundance, total_metallicity, mass_density, f_neutral=np.zeros(0), f_molec=np.zeros(0), key='Temperature'):
    ...
    '''
    internal_egy_cgs=internal_egy_code*1.e4; gamma_EOS=5./3.; kB=1.38e-16; m_proton=1.67e-24; X0=0.76;
    ...
    T_mol = 100. * (mass_density*0.404621);
    ...
    if('Number' in key or 'number' in key): return mass_density * 40.4621 / mu;
    return T;
