...
def get_temperature_from_snapshot(F):
    internal_egy_code = F["PartType0/InternalEnergy"][:]
    helium_mass_fraction = F["PartType0/Metallicity"][:, 1]
    electron_abundance = F["PartType0/ElectronAbundance"][:]
    total_metallicity = F["PartType0/Metallicity"][:, 0]
    mass_density = F["PartType0/Density"][:]
    f_neutral = F["PartType0/NeutralHydrogenAbundance"][:]
